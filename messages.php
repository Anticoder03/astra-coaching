    ...
    <div class="min-h-screen flex">
        ...
        <div class="bg-indigo-800 text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
            ...
            <nav>
                ...
                <a href="messages.php" class="block py-2.5 px-4 rounded transition duration-200 bg-indigo-900 text-white">
                    <i class="fas fa-envelope mr-2"></i>Messages
                </a>
                <a href="testimonials.php" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-indigo-700 text-white">
                    <i class="fas fa-star mr-2"></i>Testimonials
                </a>
                <a href="settings.php" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-indigo-700 text-white">
